...
def get_new_celebrity_names():
    ...
    response = client.models.generate_content(
            model=MODEL_ID,
            contents=f"Generate a list of celebrity names .like this: 'celebrity : their name'. make sure the list names that are different to {celebrity_folders}, also avoid porn stars and porn celebraties ",
